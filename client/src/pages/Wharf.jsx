...
const WharfDialogue = [
    ...
    {
        "name": "{fisherman}",
        "dialogue": "If this is the course you wish to take… than I have to ask that you study each scene where the victim was murdered… maybe even speak to witnesses again..."
    },
    {
        "name": "MC",
